defmodule BittorrentClient.HTTPHandle.InMemoryImpl do
  ...
  @arch_tracker_req_url "http://tracker.archlinux.org:6969/announce?compact=1&connected_peers=&downloaded=0&info_hash=-;=e%B3i%BAQ%92%92%DD%8C%E4%20%AF%E9Q%20%DF%1E&left=547356672&next_piece_index=0&numwant=#{
                          @num_wanted

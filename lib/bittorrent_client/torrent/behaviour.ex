defmodule BittorrentClient.Torrent do
  ...
  """
  @callback get_torrent_data(torrentID :: String.t) :: {atom(), {atom(), map()}, tuple()}

  @doc """
  connect_to_tracker attempts to connect a torrent process to it's relative tracker to retrieve a peer list.
  """
  @callback connect_to_tracker(torrentID :: String.t) :: {atom(), {atom(), String.t}, tuple()}
  ...
  @doc """
  """
  @callback get_peers(torrentID :: String.t) :: {atom(), {atom(), struct()}, tuple()}
  ...
  @doc """
  """
  @callback get_next_piece_index(torrentID :: String.t, List.t) :: {atom(), tuple(), tuple()}
